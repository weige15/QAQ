...
Active repository consumers use ``scripts/validate_lookahead_quality_protocol.py``.  This shim preserves
...
def main() -> None:
    target = Path(__file__).with_name("validate_lookahead_quality_protocol.py")
