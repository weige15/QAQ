...
def main() -> int:
    ...
    tokenizer = AutoTokenizer.from_pretrained(
        str(baseline_training.SNAPSHOT),
        revision=baseline_training.MODEL_REVISION,
    ...
    examples = [
        baseline_training._device_example(example, args.device, torch) for example in examples_cpu
    ]
    ...
    def soft_once(example):
        ...
        records = baseline_training._records_for_state(
            example.example_id, state, student, log_base=2.0
        )
