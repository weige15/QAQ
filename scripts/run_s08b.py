...
Active repository consumers use ``scripts/evaluate_synchronous_packed_loading.py``.  This shim preserves
...
def main() -> None:
    target = Path(__file__).with_name("evaluate_synchronous_packed_loading.py")
