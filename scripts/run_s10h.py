...
Active repository consumers use ``scripts/run_broader_router_validation.py``.  This shim preserves
...
def main() -> None:
    target = Path(__file__).with_name("run_broader_router_validation.py")
