...
Active repository consumers use ``scripts/evaluate_static_model_quality.py``.  This shim preserves
...
def main() -> None:
    target = Path(__file__).with_name("evaluate_static_model_quality.py")
