...
Active repository consumers use ``scripts/validate_baseline_evaluation_protocol.py``.  This shim preserves
...
def main() -> None:
    target = Path(__file__).with_name("validate_baseline_evaluation_protocol.py")
