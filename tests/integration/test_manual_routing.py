...
def test_manual_all_four_matches_verified_static_four(manual_case, static_case, manifest):
...
def test_manual_all_eight_matches_verified_static_eight(manual_case, static_case, manifest):
    manual_model, manual_inputs, torch = manual_case
    static_model, static_inputs, _ = static_case
