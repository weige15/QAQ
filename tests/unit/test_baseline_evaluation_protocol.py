...
from scripts import validate_baseline_evaluation_protocol as validator
from scripts.validate_baseline_evaluation_protocol import (
    EXPECTED_MODE_IDS,
...
def _config_and_prompt():
    ...
    prompt_payload = json.loads((ROOT / "configs/baseline_evaluation_prompts.json").read_text())
